...
{
    /// <summary>
    /// Delegate type that can listen to when the bus starts.
    /// </summary>
    ...
    /// </summary>
    public delegate void MessageSentEventHandler(IBus advancedBus, string destination, object message);
    
    /// <summary>
    /// Delegate type that can listen to whenever the bus received a logical message.
    /// </summary>
    public delegate void BeforeMessageEventHandler(IBus advancedBus, object message);
    
    /// <summary>
    /// Delegate type that can listen to whenever the bus received a logical message.
    /// </summary>
    public delegate void AfterMessageEventHandler(IBus advancedBus, Exception exception, object message);
    
    /// <summary>
    /// Delegate type that can listen to whenever the bus has received a transport message, but it has not yet been deserialized.
    /// </summary>
    public delegate void BeforeTransportMessageEventHandler(IBus advancedBus, ReceivedTransportMessage receivedTransportMessage);
    ...
    /// </summary>
    public delegate void AfterTransportMessageEventHandler(IBus advancedBus, Exception exceptionOrNull, ReceivedTransportMessage receivedTransportMessage);
    ...
    /// </summary>
    public delegate void PoisonMessageEventHandler(IBus advancedBus, ReceivedTransportMessage receivedTransportMessage, PoisonMessageInfo poisonMessageInfo);
